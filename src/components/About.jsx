        ...
        <div className="container2 m-auto">
            <div className="grid gap-16 md:grid-cols-[40%_20%_40%] md:gap-0 p-2">
                ...
                <div data-aos={animate}>
                    <h2 className="text-purple font-bold mb-10 text-5xl">About</h2>
                ...
                <div className="flex justify-center">
                    <div className="bg-purple w-1 h-full rounded-3xl"></div>
                </div>

                <div data-aos={animate} className="flex flex-col items-center">
                    <h2 className="text-purple font-bold mb-10 text-5xl">Hobbies</h2>
