        ...
        <div className="container2 m-auto">
            <div className="grid grid-cols-2 p-2">
                ...
                <div>
                    ...
                    <p className="text-lg text-blue-dark mb-8">Soy desarrollador web tanto de front-end como back-end. Me gusta todo lo que tiene que ver con el desarrollo de páginas web por lo que investigo a menudo como puedo mejorar en estas tecnologías.</p>

                    <p className="text-lg text-blue-dark">Soy desarrollador web tanto de front-end como back-end. Me gusta todo lo que tiene que ver con el desarrollo de páginas web por lo que investigo a menudo como puedo mejorar en estas tecnologías.</p>
                </div>
            </div>
        </div>
    </section>
