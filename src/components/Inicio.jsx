  ...
  return (
    <section id="home" className="container2 grid grid-cols-2 m-auto pt-36 pb-20 text-center">
      <div data-aos={animate} className="">
        <h1 className="m-0 mb-4 font-bold pb-2 px-5 text-[4rem] bg-gradient-to-t from-orange to-yellow bg-clip-text text-transparent leading-[1]">Diego Andrés Noriega Izquierdo</h1>
