...
export const Inicio = () => {
  ...
  return (
    <section id="home" className=" bg-purple">
      <div className="container2 grid grid-cols-2 m-auto pt-36 pb-20 text-center">
        <div data-aos={animate} className="">
          <h1 className="m-0 mb-4 font-bold pb-2 px-5 text-[4rem] text-white leading-[1]">Diego Andrés Noriega Izquierdo</h1>
        ...
        <div data-aos={animate} className="flex flex-col gap-6 justify-center items-center">
            <img className="w-64 rounded-[50%] bg-white p-1 shadow-2xl animate-img" src="/img/perfil.png" alt="I'm Diego Noriega" />
