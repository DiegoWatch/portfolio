...
export const Inicio = () => {
  return (
    <section id="home" className="home bg-gradient-to-t from-blue-dark-1 to-blue-light-1 pt-36 pb-20 text-center">
        ...
        <div className="mt-10">
          <Link to="#contact" smooth className="p-5 bg-blue-dark inline-block rounded-xl">Contact Me</Link>
        </div>
    </section>
